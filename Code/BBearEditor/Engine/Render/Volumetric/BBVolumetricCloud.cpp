...
void BBVolumetricCloud::setScreenQuadPass(BBScene *pScene)
{
    ...
    pMaterial->setSampler3D("PerlinNoiseTex3D", BBProcedureTexture().createPerlinNoiseTexture3D(32, 32, 32, 0.125f));
    pMaterial->setSampler2D("DistortTex", BBTexture().createTexture2D(BB_PATH_RESOURCE_TEXTURE(Noise/dissolveTex1.jpg)));
